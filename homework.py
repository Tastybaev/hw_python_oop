...
class Calculator:
    ...
    def get_today_stats(self):
        return sum(i.amount for i in self.records if i.date == dt.datetime.today().date())
...
class CaloriesCalculator(Calculator):
    ...
    def get_calories_remained(self, limit):
        ...
        if calories_limit <= limit:
            ...
            return f'Сегодня можно съесть что-нибудь ещё, но с общей калорийностью не более {over_limit} кКал'
        else:
            return 'Хватит есть!'
